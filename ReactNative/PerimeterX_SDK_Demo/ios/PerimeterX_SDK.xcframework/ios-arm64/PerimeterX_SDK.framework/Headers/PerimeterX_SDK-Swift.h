...
/// Start the SDK.
/// Call this function to start th SDK with a single AppID. You should call this function only once. You should call this function only from the main thread. If you need to be notified that the SDK is ready in other places in your code, you can use the <code>addInitializationFinishedCallback(forAppId:callback:)</code> function.
/// \param appId The AppID of your account.
///
...
/// Start the SDK.
/// Call this function to start th SDK with multiple AppIDs. You should call this function only once. You should call this function only from the main thread. If you need to be notified that the SDK is ready in other places in your code, you can use the <code>addInitializationFinishedCallback(forAppId:callback:)</code> function. This function may throw an error.
...
/// Returns <code>true</code> if the PerimeterX’s payload in the response can be handled by the SDK. This function does not present the block screen. This function should be used only when the <code>PXPolicy/urlRequestInterceptionType</code> is set to <code>PXPolicyUrlRequestInterceptionType/none</code> in the policy.
...
///
+ (NSString * _Nullable)registerCallbackForRequestBlockedEventForAppId:(NSString * _Nullable)appId callback:(void (^ _Nonnull)(NSURL * _Nullable))callback SWIFT_WARN_UNUSED_RESULT;
